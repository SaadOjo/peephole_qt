#include "vp_speaker.h"

vp_speaker::vp_speaker(QObject *parent) :
    QObject(parent)
{
    periods = 2;
...
void vp_speaker::start()
{
   init();
   started = true;
}
bool vp_speaker::isStarted()
{
    return started;
}
void vp_speaker::stop()
{
...
void vp_speaker::playSound(safe_sound  *sound)
{
    sound->mutex.lock();
...
void vp_speaker::init()
{

    fprintf(stderr, "Initialising vp_speaker! \n");
