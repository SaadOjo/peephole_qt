...
int video_decoder_thread::packet_queue_put(safe_sound_queue *q, AVPacket *pkt)
{
    AVPacketList *pkt1;
...
void video_decoder_thread::run(){
    ...
    audio_start_context.CodecCtx = aCodecCtx;
    ...
    if(packet.stream_index==videoStream)
        ...
        {
            packet_queue_put(&myQueue, &packet); //can instead put decoded packets
