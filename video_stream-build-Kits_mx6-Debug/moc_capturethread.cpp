...
#include "../video_stream/capturethread.h"
...
static const char qt_meta_stringdata_CaptureThread[] = {
    "CaptureThread\0\0image\0"
    "renderedImage(image_with_mutex*)\0"
    "give_encode_video_context(safe_encode_video_context*)\0"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->renderedImage((*reinterpret_cast< image_with_mutex*(*)>(_a[1]))); break;
        case 1: _t->give_encode_video_context((*reinterpret_cast< safe_encode_video_context*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void CaptureThread::renderedImage(image_with_mutex * _t1)
{
...
// SIGNAL 1
void CaptureThread::give_encode_video_context(safe_encode_video_context * _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
