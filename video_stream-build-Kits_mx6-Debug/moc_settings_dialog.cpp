...
#include "../video_stream/settings_dialog.h"
...
const QMetaObjectExtraData settings_dialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject settings_dialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_settings_dialog,
      qt_meta_data_settings_dialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &settings_dialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_settings_dialog))
        return static_cast<void*>(const_cast< settings_dialog*>(this));
